...
5,214 sources across 12 macro-categories:
...
**`Provenienza`** records which directory a row came from and in which batch, as `<list>:<YYYY-MM>` — `ifcn:2026-08`, `opensanctions:2026-08`, `unsd:2026-09`, `wikipedia.nso:2026-09`, `occrp:2026-09`, `first:2026-09`. `scripts/discover_candidates.py` stamps it automatically; rows added by hand leave it empty.
